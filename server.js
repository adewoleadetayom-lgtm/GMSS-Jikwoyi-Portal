...
async function initDB() {
  ...
  await pool.query(`
    ...
    ALTER TABLE library ADD COLUMN IF NOT EXISTS description TEXT DEFAULT '';
    ALTER TABLE library ADD COLUMN IF NOT EXISTS category TEXT DEFAULT 'General';
    ALTER TABLE library ADD COLUMN IF NOT EXISTS filename TEXT DEFAULT '';
    ALTER TABLE library ADD COLUMN IF NOT EXISTS url TEXT DEFAULT '';
    ALTER TABLE library ADD COLUMN IF NOT EXISTS mime_type TEXT DEFAULT '';
    ALTER TABLE library ADD COLUMN IF NOT EXISTS size BIGINT DEFAULT 0;
